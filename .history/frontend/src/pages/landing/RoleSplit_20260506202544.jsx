...
import doc1 from '../../assets/que.png';
          ...
          <div className="inline-flex rounded-xl p-1 gap-1"
            ...
            {Object.entries(ROLES).map(([key, r]) => (
              <button
                ...
                className="flex items-center gap-2 px-5 text-sm font-semibold rounded-lg transition-all duration-200"
                style={{
                  height: 'var(--btn-h-sm)',
                  backgroundColor: active === key ? role.accent : 'transparent',
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center reveal">
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: '4/5' }}>
            ...
            <div className="absolute inset-0"
                 style={{ background: `linear-gradient(to top, ${role.accent}cc 0%, transparent 50%)` }} />
          </div>
