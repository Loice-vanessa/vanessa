...
export default function Hero() {
  return (
    <section className="relative flex items-center overflow-hidden"
      ...
      <div className="relative w-full max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-16 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
