...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Dark overlay — heavier on left so text pops, fades right */}
      <div className="absolute inset-0"
           style={{ background: 'linear-gradient(105deg, rgba(5,46,22,0.92) 0%, rgba(5,46,22,0.75) 45%, rgba(5,46,22,0.35) 100%)' }} />
